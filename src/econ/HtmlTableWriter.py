...
class HtmlTableWriter:
	...
	def __init__(self):
		...
		# number of decimal places to use when rounding numerical values when textifying for table
		self.decimalPlaces = 2
	
	def writeTable(self, data, caption = '', columnHeadings = [], rowHeadings = []):
		"""
		...
		# note that if we there are rowHeadings have to add blank column at front
